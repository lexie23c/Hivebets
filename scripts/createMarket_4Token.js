...
async function main() {
  ...
  console.log("Creating production market for $4 token on BSC Mainnet...");
  ...
  const tokenName = "$4";
  const title = `Will ${tokenName} hit $444M mcap before October 30?`;
  const dataSource = `https://dexscreener.com/bsc/${tokenAddr}`;
  const target = usd8("444000000"); // $444M
  ...
  console.log("  Target Market Cap: $444,000,000");
  ...
  console.log("  Token:", tokenAddr);
  console.log("  Target: $444,000,000");
